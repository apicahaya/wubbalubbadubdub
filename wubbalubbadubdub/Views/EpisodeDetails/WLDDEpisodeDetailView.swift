...
final class WLDDEpisodeDetailView: UIView {
    ...
    public func configure(with viewModel: WLDDEpisodeDetailViewViewModel) {
...
extension WLDDEpisodeDetailView: UICollectionViewDataSource, UICollectionViewDelegate {
